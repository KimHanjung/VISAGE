...
from visage.data_video.dataset_mapper import CocoClipDatasetMapper
...
def setup(args):
    ...
    setup_logger(output=cfg.OUTPUT_DIR, distributed_rank=comm.get_rank(), name="VISAGE")
    return cfg
